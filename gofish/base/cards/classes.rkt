(module classes racket/base
  (require racket/class
           ;(prefix-in mred: racket/draw)
           (prefix-in mred: (only-in racket/gui/base pasteboard% editor-canvas% frame%))
...
(define (show-help . arg*)
  (lambda () (error 'show-help "Not implemented")))

(define (show-scribbling . arg*)
  (lambda () (error 'show-scribbling "Not implemented")))

  (provide ;;bg;pasteboard%
	   table%)
