#lang racket/base
(require racket/class racket/bool ; sugar/container sugar/list sugar/debug
         racket/list "helper.rkt" "variable.rkt")
(provide (all-defined-out))

;; -----------------------------------------------------------------------------
;; bg: from sugar

(define (members-unique? x)
  (= (length (remove-duplicates x)) (length x)))
