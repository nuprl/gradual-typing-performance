...
(define (jude) (make-sample "./base/texts/jude.txt"))
(define (jude0) (make-sample "../base/texts/jude0.txt"))
(define (judebig) (make-sample "../base/texts/judebig.txt"))
(define (segfault) (make-sample "../base/texts/segfault.txt"))
