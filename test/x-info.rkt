...
;; ---------------------------------------------------------------------------------------------------
; (require scribble/render setup/xref)
(require typed/racket/class)
(require/typed
  scribble/html-render
    [render-multi-mixin (-> ClassTop ClassTop)]
    [render-mixin       (-> ClassTop ClassTop)]
)
...
(: process-whole (-> Boolean
                     (-> Boolean String String (U #f String) (-> ClassTop ClassTop) Any * Void)
