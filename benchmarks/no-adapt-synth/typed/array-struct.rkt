...
(safe-and-unsafe-provide
 (rename-out
   (array-unsafe-proc unsafe-array-proc)
   (ext:array-strict? array-strict?)
   (ext:array-strict! array-strict!)
   (ext:array-default-strict! array-default-strict!)
 )
 array-strictness
 build-array
 make-array
...
(: ext:array-strict? (Array -> Boolean))
(define (ext:array-strict? arr)
  (unbox (array-i:strict? arr)))

(: ext:array-strict! (Array -> Void))
(define (ext:array-strict! arr)
  (define strict? (array-i:strict? arr))
  (unless (unbox strict?)
    ((array-i:strict! arr))
    (set-box! strict? #t)))

(: ext:array-default-strict! (Array -> Void))
(define (ext:array-default-strict! arr)
  (define strict? (array-i:strict? arr))
...
(: unsafe-vector->array (Indexes (Vectorof Float) -> Array))
(define (unsafe-vector->array ds vs)
  ...
  (array ds (vector-length vs) (box #t) void proc))
