...
wget https://mirror.racket-lang.org/installers/6.2/racket-6.2-i386-linux-ubuntu-precise.sh
...
sh racket-6.2-i386-linux-ubuntu-precise.sh --in-place --dest ~/racket
...
# Cleanup
rm ~/Desktop/racket-6.2-i386-linux-ubuntu-precise.sh
