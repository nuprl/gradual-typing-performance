...
(require (for-syntax racket/syntax racket/base) racket/string racket/contract racket/list sugar/debug racket/bool racket/function math/flonum)
(require "quads.rkt" "world.rkt" "measure.rkt" "hyphenate.rkt")
